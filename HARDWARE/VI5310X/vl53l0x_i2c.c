...
void VL53L0X_i2c_init(void)
{
	...
	GPIO_SetBits(GPIOD,GPIO_Pin_3|GPIO_Pin_4);		//输出高	
}
...
#define VL_IIC_SCL(n)	n?(GPIOD->BSRR=GPIO_Pin_3):\
							(GPIOD->BRR=GPIO_Pin_3)
#define VL_IIC_SDA(n)	n?(GPIOD->BSRR=GPIO_Pin_4):\
							(GPIOD->BRR=GPIO_Pin_4)

#define VL_READ_SDA		GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_4)
